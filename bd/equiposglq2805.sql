...
CREATE TABLE `asignar` (
  ...
  `observd` varchar(512) DEFAULT NULL,
...
INSERT INTO `equipo` (`idequ`, `marca`, `modelo`, `serialeq`, `nomred`, `idvtpeq`, `capgb`, `ram`, `procs`, `fecultman`, `fecproman`, `actequ`, `tipcon`, `contrato`, `valrcont`, `pagequ`) VALUES
(1, 'HP', '24-g003la', '8CC6381SMQ', 'ADM_FN_CON_04', 8, 512, 16, 'i5-6200U CP', '2024-05-01', '2024-06-01', 1, 10, '', 0, 52),
(2, 'Samsung', 'A21s', '351261442981315', NULL, NULL, 128, 16, NULL, NULL, NULL, 1, NULL, NULL, NULL, 54);
...
(54, 'fa fa-solid fa-mobile', 'Celulares', 'views/vequ.php', 54, 'home.php', 1, 1);
