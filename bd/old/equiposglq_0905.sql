...
INSERT INTO `perfil` (`idpef`, `nompef`, `idmod`) VALUES
(1, 'Administrador', 2);
...
--
ALTER TABLE `pagina`
  MODIFY `idpag` bigint(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=8;
...
--
ALTER TABLE `perfil`
  MODIFY `idpef` bigint(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
