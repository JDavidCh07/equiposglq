...
INSERT INTO `equipo` (`idequ`, `marca`, `modelo`, `serialeq`, `nomred`, `idvtpeq`, `capgb`, `ram`, `procs`, `fecultman`, `fecproman`, `actequ`, `tipcon`, `contrato`, `valrcont`) VALUES
(1, 'HP', '24-g003la', '8CC6381SMQ', 'ADM_FN_CON_04', 8, 512, 16, 'i5-6200U CP', '2024-05-01', '2024-06-01', 1, 10, '', 0);
...
CREATE TABLE `asignar` (
  ...
  `idequ` bigint(11) NULL,
  `idcel` bigint(11) NULL,
...
(3, '0002445012', '0001710650 026,06714', 1, 1, '2024-04-18', NULL, NULL, NULL, 1);
...
--
ALTER TABLE `celular`
  MODIFY `idcel` bigint(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT de la tabla `equipo`
--
ALTER TABLE `equipo`
  MODIFY `idequ` bigint(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
...
--
ALTER TABLE `tarjeta`
  MODIFY `idtaj` bigint(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;
...
--
ALTER TABLE `accxequi`
  ADD CONSTRAINT `accxequi__ibfk_1` FOREIGN KEY (`idequ`) REFERENCES `asignar` (`ideqxpr`);
...
ALTER TABLE `asignar`
  ...
  ADD CONSTRAINT `asignar_ibfk_2` FOREIGN KEY (`idcel`) REFERENCES `celular` (`idcel`),
